...
const PlaceOrder = () => {
  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      ...
      // Ensure token from context or localStorage
  ...
  return (
    <form
      ...
      className="flex flex-col lg:flex-row gap-1 lg:gap-10 pt-10 border-t border-[#ffd7d7] -mt-18 sm:-mt-28 -ml-2"
    >
      ...
      <div className="flex flex-col gap-4 w-full lg:w-[50%] ml-2 sm:ml-7 -mt-2">
        ...
        <input
          className={`border py-1.5 px-3.5 w-full ${
            touched.email && errors.email ? 'border-red-500' : 'border-[#ffc6db]'
          }`}
        ...
        <input
          className={`border py-1.5 px-3.5 w-full ${
            touched.street && errors.street ? 'border-red-500' : 'border-[#ffc6db]'
          }`}
          placeholder="Street"
          name="street"
          value={form.street}
        ...
        {touched.street && errors.street && (
          <p className="text-red-500 text-xs -mt-3">{errors.street}</p>
        )}
        ...
        <div className="flex gap-3">
          <div className="w-full">
            <input
              className={`border py-1.5 px-3.5 w-full ${
                touched.city && errors.city ? 'border-red-500' : 'border-[#ffc6db]'
              }`}
              placeholder="City"
              name="city"
              value={form.city}
        ...
        <input
          className={`border py-1.5 px-3.5 w-full ${
            touched.phone && errors.phone ? 'border-red-500' : 'border-[#ffc6db]'
          }`}
          placeholder="Phone"
          name="phone"
          value={form.phone}
        ...
        <div className="mt-12">
          ...
          <div className="flex flex-col lg:flex-row gap-3 mt-0 overflow-x-auto lg:overflow-visible font-bold">
            {[
              ...
              <label
                key={idx}
                className={`flex items-center border px-3 py-3 cursor-pointer ${
                  method === key
                    ? 'border-[#ff92b8] shadow-sm'
                    : 'border-[#ffc6db]'
                } transition gap-2 min-w-[170px]`}
              >
                <input
                  type="radio"
                  name="payment"
                ...
                {logo ? (
                  <img
                    className="h-7 w-20 object-contain ml-1"
                    src={logo}
                    alt="Payment Logo"
                  />
                ) : (
          ...
          <div className="w-full text-end mt-3">
            <button
              ...
              className={`px-16 py-2 text-medium font-bold -mr-0 sm:ml-16 ${
                isValid
