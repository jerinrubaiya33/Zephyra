...
// __________________50%___________________
// import React, { useContext, useEffect, useState } from "react";
// import { ShopContext } from "../context/ShopContext";
// import Title from "./Title";
// import ProductItem from "./ProductItem";
...
//       .map((item) => ({
//         ...item,
//         discount: 50, // force 50% discount
//         finalPrice: Math.round((item.price / 2) * 100) / 100, // number not string
//       }));
...
//         <Title text1={"BEST"} text2={"SELLERS"} />
//         <p className="w-full sm:w-3/4 md:w-2/4 m-auto text-sm sm:text-base md:text-lg text-black">
//           Crafted for distinction. These best sellers blend refined design with
//           elevated comfort — timeless pieces made for those who move with quiet
//           confidence.
//         </p>
//       </div>
