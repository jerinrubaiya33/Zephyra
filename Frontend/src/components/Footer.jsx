        ...
        <div className="w-screen -ml-4 sm:-ml-27.5 bg-[#f76097] text-white">
            <div className='grid grid-cols-1 sm:grid-cols-[3fr_1fr_1fr] gap-10 sm:gap-14 my-10 mt-15 text-sm px-4 sm:px-10 -ml-2'>
                <div>
                    ...
                    sm:-ml-17' alt="logo" />
                    <p className='w-full -mt-22 sm:-ml-2 ml-2  md:w-3/3 text-sm sm:text-base md:text-lg text-white'>
                ...
                {/* Company Links */}
                <div className='mt-0 ml-2 sm:ml-0 sm:mt-18 text-start sm:text-left'>
                    <p className='text-2xl font-bold mb-5'>COMPANY</p>
                    <ul className='flex flex-col gap-0 sm:gap-1 sm:mt-0 -mt-3.5 text-white text-xl'>
                ...
                {/* Contact */}
                <div className='mt-0 sm:mt-18 text-start sm:text-left ml-2 sm:ml-0'>
                    <p className='text-2xl font-bold mb-5'>GET IN TOUCH</p>
                    <ul className='flex flex-col gap-1 text-white text-xl sm:mt-0 -mt-2'>
