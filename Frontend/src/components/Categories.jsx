        ...
        <div key={section.name} className="flex flex-col mb-14 md:mb-20">
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-gray-100/20 px-4 text-center">
              ...
              <button className="bg-[#9C7E63] border border-white text-white px-6 py-2 md:px-10 md:py-3 text-xs md:text-sm font-bold uppercase tracking-widest hover:bg-[#55493f] hover:text-white transition-colors duration-300 shadow-xl">
                Shop Now
              </button>
            </div>
          </div>
