...
//   return (
//     <div className="flex flex-col w-screen md:-ml-28 mt-12 md:mt-20">
//       {categoryData.map((section) => (
//         <div key={section.name} className="flex flex-col mb-14 md:mb-20">

//           {/* BANNER */}
//           <div
//             className="w-full h-[300px -ml-4 sm:ml-0 md:h-[600px] relative cursor-pointer overflow-hidden group"
...
//             <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3 md:gap-4 gap-y-5 md:gap-y-6">
...
//               {/* VIEW ALL */}
//               <div
//                 className="min-h-[180px] md:min-h-[250px] border-2 border-dashed border-gray-400 flex flex-col items-center justify-center cursor-pointer hover:border-[#f76097] group/all transition-colors"
//                 onClick={() => navigate(section.link)}
//               >
//                 <span className="text-2xl md:text-3xl text-gray-400 group-hover/all:text-[#f76097] mb-2">+</span>
//                 <span className="font-bold text-gray-400 group-hover/all:text-[#f76097] text-[10px] md:text-xs tracking-widest">
//                   VIEW ALL
//                 </span>
//               </div>
//             </div>
    ...
    <div className="flex flex-col w-screen md:-ml-28 mt-12 md:mt-20">
      {categoryData.map((section) => (
        <div key={section.name} className="flex flex-col mb-14 md:mb-20">
          ...
          {/* PRODUCT GRID */}
          <div className="px-4 sm:px-2 md:px-12 lg:px-20">
            <div className="relative md:static left-[-10px] md:left-0 scale-[0.96] md:scale-100 origin-left grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-2 md:gap-4 gap-y-4 md:gap-y-6">
