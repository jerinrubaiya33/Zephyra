        ...
        <div className="flex items-center justify-between py-5 font-medium relative">
            ...
            <div className='flex items-center gap-6'>
                ...
                <Link to="/cart" className="relative">
                    ...
                    <p className="absolute right-[-6px] bottom-[38px] min-w-[16px] h-4 px-[2px] text-center bg-black text-white rounded-full text-[20px] flex items-center justify-center">
                        {getCartCount()}
                    </p>
                </Link>
